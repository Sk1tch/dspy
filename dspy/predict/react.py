...
class ReAct(Module):
    def __init__(
        ...
        Args:
            ...
            keep_last_n_steps (Optional[int]): Number of recent trajectory steps to keep when truncating. If None, keeps all steps.
    ...
    def _call_with_retry(self, module, trajectory, idx, **input_args):
        ...
        for retry_count in range(max_retries):
            try:
                pred = self._call_with_potential_trajectory_truncation(module, trajectory, **input_args)
    ...
    async def _async_call_with_retry(self, module, trajectory, idx, **input_args):
        ...
        for retry_count in range(max_retries):
            try:
                pred = await self._async_call_with_potential_trajectory_truncation(module, trajectory, **input_args)
    ...
    def _call_with_potential_trajectory_truncation(self, module, trajectory, **input_args):
        for _ in range(3):
            try:
                ...
                logger.warning("Trajectory exceeded the context window, truncating trajectory.")
